# LocA(Location-AMI) ![Python](http://ForTheBadge.com/images/badges/made-with-python.svg) ![Downloads](https://img.shields.io/github/downloads/{username}/{repo-name}/total.svg)
